...
import { QrCode, LogIn, Zap, BarChart3 } from "lucide-react";
...
export function LandingPage({ onNavigate }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 relative overflow-hidden flex flex-col">
      ...
      {/* Hero Section */}
      <div className="container mx-auto px-6 md:px-12 lg:px-16 xl:px-24 py-16 md:py-24 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-6">
              ...
              <h1 className="text-blue-900 leading-tight font-bold">
                DPR Tool Management System
              </h1>
              <p className="text-muted-foreground leading-relaxed text-[14px]">
                Smart tool tracking system for DPR Aviation College's maintenance hangar.
                Reduce tool losses, improve accountability, and automate recording of transactions with cutting-edge QR technology.
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-blue-900 mb-2 flex items-center gap-2">
                        Proceed to QR Scan
                        <span className="text-xs px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full">Student</span>
                      </h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-blue-900 mb-2 flex items-center gap-2">
                        ...
                        <span className="text-xs px-2 py-0.5 bg-slate-100 text-slate-700 rounded-full">Staff</span>
                      </h3>
                      <p className="text-muted-foreground text-sm mb-4">
                        Access management dashboard and comprehensive tool tracking features
                      </p>
                      <Button variant="outline" className="w-full border-slate-300 hover:bg-slate-100 hover:border-slate-400 hover:text-slate-900 transition-all">
